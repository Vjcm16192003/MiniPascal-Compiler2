...
public interface MiniPascalListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code writer}
	 * labeled alternative in {@link MiniPascalParser#procedureStatement}.
	 * @param ctx the parse tree
	 */
	void enterWriter(MiniPascalParser.WriterContext ctx);
	/**
	 * Exit a parse tree produced by the {@code writer}
	 * labeled alternative in {@link MiniPascalParser#procedureStatement}.
	 * @param ctx the parse tree
	 */
	void exitWriter(MiniPascalParser.WriterContext ctx);
	/**
	 * Enter a parse tree produced by the {@code reader}
	 * labeled alternative in {@link MiniPascalParser#procedureStatement}.
	 * @param ctx the parse tree
	 */
	void enterReader(MiniPascalParser.ReaderContext ctx);
	/**
	 * Exit a parse tree produced by the {@code reader}
	 * labeled alternative in {@link MiniPascalParser#procedureStatement}.
	 * @param ctx the parse tree
	 */
	void exitReader(MiniPascalParser.ReaderContext ctx);
	/**
